...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/getprobyid?url=providerview.jsp&proid="+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/getprobyid?url=providermodify.jsp&proid="+ obj.attr("proid");
	});
